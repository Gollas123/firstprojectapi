...
* The original package name 'com.myfirstspringproject.first-spring-restapi' is invalid and this project uses 'com.myfirstspringproject.firstspringrestapi' instead.
